            ...
            .gesture(
                DragGesture()
                    .onChanged { value in
                        ...
                        let currentVector = CGPoint(x: currentNorm.x - centerNorm.x, y: currentNorm.y - centerNorm.y)
                        let prevVector = CGPoint(x: previousNorm.x - centerNorm.x, y: previousNorm.y - centerNorm.y)
